...
function Navbar() {
  ...
  return (
    <header className="flex items-center justify-between h-20 px-8 bg-indigo-800 text-white">
      <img src={logo} alt="Logo" className="h-12" />
      <nav
        className={`absolute top-0 left-0 w-full h-screen flex flex-col items-start p-8 pt-20 bg-white text-black transition-transform duration-500 md:static md:flex-row md:h-auto md:w-auto md:bg-indigo-800 md:text-white md:items-center md:gap-6 md:p-0 md:pt-0 md:transition-none ${
